function Align_LVP_AOP_Peak_Discontinuity
...
study_name='Aortic_Pressure_Separate_Study/STF-13-MR-273273.xls';
AOPressure=ExtractAorticPressure(study_name);
...
study_name='LV_Pressure_Separate_Study/STF-13-MR-273273.xlsx';
LVPressure=ExtractLVPressure(study_name);
...
title(['LV & Aortic Pressure Study ',study_name(25:30)],'FontSize',12);
%legend('Aortic Pressure','LV Pressure','ES','EndIVC');
...
%}
MRI_file='LV_Pressure_Separate_Study/STF-13_MRI_info.mat';
study_name='STF_13';
