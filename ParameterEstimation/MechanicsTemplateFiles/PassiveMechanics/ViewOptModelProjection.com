...
gfx read node;output/LV_Inflation_OptC1
gfx read elem;output/LV_Inflation_OptC1
gfx modify g_element LVInflation_OptC1 general clear circle_discretization 6 default_coordinate deformed element_discretization "12*12*12" native_discretization none;
gfx modify g_element LVInflation_OptC1 lines select_on material default selected_material default_selected;
gfx modify g_element LVInflation_OptC1 cylinders constant_radius 0.3 select_on material muscle selected_material default_selected render_shaded;
gfx modify g_element LVInflation_OptC1 surfaces face xi3_1 select_on material muscle selected_material default_selected render_shaded;
...
gfx modify g_element CAPED_Endo data_points glyph sphere general size "1*1*1" centre 0,0,0 font default select_on material green selected_material default_selected;
...
gfx modify g_element CAPED_Epi data_points glyph sphere general size "1*1*1" centre 0,0,0 font default select_on material green selected_material default_selected;

gfx change data_offset 10000
gfx read data;CAPEDEndo_Error_ToED
...
gfx change data_offset 10000
gfx read data;CAPEDEpi_Error_ToED
