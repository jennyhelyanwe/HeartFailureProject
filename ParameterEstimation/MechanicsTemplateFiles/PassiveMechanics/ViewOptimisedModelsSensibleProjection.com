...
for ($i=$DS+1;$i<=$tot;$i=$i+1)
{
	gfx read data;OptimisedError/EndoError_${i}_sensible time $t region EndoError;
	$t ++;
	
}
gfx read data;OptimisedError/EndoError_${ED}_sensible time $t region EndoError;
...
for ($i=$DS+1;$i<=$tot;$i=$i+1)
{
	gfx read data;OptimisedError/EpiError_${i}_sensible time $t region EpiError;
	$t ++;
	
}
gfx read data;OptimisedError/EpiError_${ED}_sensible time $t region EpiError;
