...
filename_Epi = 'output_debug/ED_model_surface_epi.ipdata'
filename_Endo = 'output_debug/ED_model_surface_endo.ipdata'
...
SDEpi = readIpdata('Surface_Points_Epi_ED.ipdata')
SDEndo = readIpdata('Surface_Points_Endo_ED.ipdata')
