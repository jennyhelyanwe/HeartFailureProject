...
$file="ForwardSolveExfile/LVInflation_".${i};	
gfx read node;$file region LVModel time $time;
gfx read element;"ForwardSolveExfile/LVInflation_".${finish} region LVModel
...
for ($i=$start;$i<=$finish;$i=$i+1)  
{
	$file="../../../../../GeomData/STF_01/Passive/STF_01_Surface_Points_Epi_".${i};
...
for ($i=$start;$i<=$finish;$i=$i+1) 
{
	$file="../../../../../GeomData/STF_01/Passive/STF_01_Surface_Points_Endo_".${i};	
